...
public class DMFragmentTabHost extends TabHost implements
    ...
    public DMFragmentTabHost(Context context) {
    ...
    public DMFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
